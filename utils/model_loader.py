...
class ModelLoader:
    ...
    def _validate_env(self):
        ...
        if missing_vars:
            ...
            raise DocumentException("Missing environment variables", sys)
        log.info("Environment variables validated", available_keys=[key for key in self.api_keys if self.api_keys[key]])
