...
class ConversationalRAG:
    ...
    def __init__(self, session_id: Optional[str], retriever=None):
        try:
            ...
            raise DocumentException("Initialization error in ConversationalRAG", sys)
    ...
    def load_retriever_from_faiss(
        ...
        try:
            ...
            raise DocumentException("Loading error in ConversationalRAG", sys)
    ...
    def invoke(self, user_input: str, chat_history: Optional[List[BaseMessage]] = None) -> str:
        ...
        try:
            ...
            raise DocumentException("Invocation error in ConversationalRAG", sys)
    ...
    def _load_llm(self):
        try:
            ...
            raise DocumentException("LLM loading error in ConversationalRAG", sys)
    ...
    def _build_lcel_chain(self):
        try:
            if self.retriever is None:
                raise DocumentException("No retriever set before building chain", sys)
            ...
            raise DocumentException("Failed to build LCEL chain", sys)