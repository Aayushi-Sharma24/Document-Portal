...
class FaissManager:
    ...
    def load_or_create(self,texts:Optional[List[str]]=None, metadatas: Optional[List[dict]] = None):
        ...
        if not texts:
            raise DocumentException("No existing FAISS index and no data to create one", sys)
...
class ChatIngestor:
    def __init__( self,
        ...
        try:
            ...
            raise DocumentException("Initialization error in ChatIngestor", e) from e
    ...
    def built_retriver( self,
        ...
        *,
        ...
        try:
            ...
            raise DocumentException("Failed to build retriever", e) from e
...
class DocumentComparator:
    ...
    def save_uploaded_files(self, reference_file, actual_file):
        try:
            ...
            raise DocumentException("Error saving files", e) from e
    ...
    def combine_documents(self) -> str:
        try:
            ...
            raise DocumentException("Error combining documents", e) from e
