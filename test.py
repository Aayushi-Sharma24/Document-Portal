...
# PDF_PATH = r"C:\\Users\\aayus\\OneDrive\\Agentic AI\\LLMOps Project\\Document Portal\\data\\document_analysis\\sample.pdf"
...
# Testing code for multidoc chat
...
def test_document_ingestion_and_rag():
    try:
        ...
        print(f"Error in test_document_ingestion_and_rag: {e}")
        sys.exit(1)
